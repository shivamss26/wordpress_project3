...
/**
 * Title: Page Title
 * Slug: moving/page-title
 * Categories: moving, page-title
 */
?>
...
<div class="wp-block-group alignwide"><!-- wp:post-title {"textAlign":"center","style":{"typography":{"letterSpacing":"1px","fontSize":"42px"}},"textColor":"white"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->